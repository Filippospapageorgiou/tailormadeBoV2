...
<DropdownMenu.Root>
	...
	<DropdownMenu.Content align="end" class="w-48">
		...
		>
			...
			<span class="text-red-600">Delete Payment</span>
		</DropdownMenu.Item>
...
<Dialog.Root bind:open={deleteDialogOpen}>
	<Dialog.Content class="rounded-2xl p-6 shadow-lg sm:max-w-[425px]">
		<Dialog.Header class="space-y-3">
			<Dialog.Title class="text-xl font-semibold">Delete Supplier Payment</Dialog.Title>
			<Dialog.Description class="text-sm leading-relaxed text-gray-600">
				Are you sure you want to delete the payment to
				<span class="font-medium text-gray-900">"{supplierName || 'Unknown'}"</span>
