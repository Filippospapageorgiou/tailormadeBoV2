...
export const registerColumns: ColumnDef<DailyRegisterClosing>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const dateSnippet = createRawSnippet<[{ closingDate: string }]>(
        (getDate) => {
...
`,
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const salesSnippet = createRawSnippet<[{ totalSales: number }]>(
        (getSales) => {
  ...
  },
  {
    ...
    header: "Card Sales",
    cell: ({ row }) => {
      const salesSnippet = createRawSnippet<[{ cardSales: number }]>(
        (getSales) => {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const cashSnippet = createRawSnippet<[{ final_cash_balance: number }]>(
        (getCash) => {
  ...
  },
  {
    ...
    header: "Actual Cash",
    cell: ({ row }) => {
      const cashSnippet = createRawSnippet<[{ actualCash: number }]>(
        (getCash) => {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const diffSnippet = createRawSnippet<[{ difference: number }]>(
        (getDiff) => {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const paymentsSnippet = createRawSnippet<[{ payments: number }]>(
        (getPayments) => {
  ...
  },
  {
    ...
    header: "Expenses",
    cell: ({ row }) => {
      const expensesSnippet = createRawSnippet<[{ expenses: number }]>(
        (getExpenses) => {
