...
export const getRegisterClosingByDateRange = query(getRegisterByDateRangeSchema, async ({ days }) => {
  ...
  try {
    ...
    if (currentError) {
      console.error('[getRegisterClosingByDateRange] Error fetching current period data:', currentError);
      return {
        success: false,
    ...
    if (previousError) {
      console.error('[getRegisterClosingByDateRange] Error fetching previous period data:', previousError);
      return {
        success: false,
