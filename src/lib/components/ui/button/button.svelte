	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				datepicker:
					'bg-card text-foreground hover:bg-primary/10 dark:hover:bg-primary/20 border border-border/50 dark:border-border shadow-sm hover:shadow-md transition-all duration-200 hover:border-primary/30'
			},
			size: {
